...
var height;
var width;
Ext.lt.pmkpi.selfindexdepttj = function (config, service) {
    var common = Ext.lt.pmkpi.perfcommon(config, serviceid);
    var _proguid = config.proguid,//项目guid
    ...
    Ext.lt.message.hook("layout", "endlayout2", function(){
        if (typeof(maintable) != "undefined" && maintable != null) {
            maintable.resize(undefined, height*0.6);
        }
        ...
        for (var i = 0; i < cols.length; i++) {
            ...
            if (col["colcode"] == "actualvalue") { // 实际完成值
                ...
                col.oneditend = function (table, el, l, c, d) {
                    ...
                    if (d.actualvalue && d.actualweight && ((d.computesign == "1" || d.computesign == "2" || d.computesign == "3" || d.computesign == "4" || d.computesign == "5") && _rationscore != "1") || (d.computesign == "6" && _qualscore != "1")){
                        Ext.lt.pmkpi.warn(d);
                    }
                }
            }
            ...
            if (col["colcode"] == "score") { //得分
                ...
                col.oneditstart = function (table, el, l, c, d) {
                    if ((d.levelno != "3"
                        ...
                        || (d.computesign == "6" && _qualscore == "3" && d.datatype !="selfframe")) && d.isscoreEdit != 1){
                        return false;
                    }
                }
                col.oneditend = function (table, el, l, c, d) {
...
function amtTotal(table) {
    ...
    var mainsel = maintable.getRecordset().query({guid: goalguid});
    if (mainsel.length > 0) {
        mainsel[0]["weightscore"] = totalrs["score"];
