...
public class ConfirmNewService extends PmkpiService{

    private ConfirmNewBO confirmNewBO;
    public void setConfirmNewBO(ConfirmNewBO confirmNewBO) {
        this.confirmNewBO = confirmNewBO;
    }
    @Override
    ...
    public Map<String, Object> getData(HashMap<String,Object> parms) throws AppException {
        return confirmNewBO.getData(parms);
    }
    ...
    public String getProCode(HashMap<String,Object> parms) throws AppException {
        return confirmNewBO.getProCode(parms);
    }
    ...
    public Map<String, Object> getdeptData(HashMap<String,Object> parms) throws AppException {
        return confirmNewBO.getdeptData(parms);
    }
}
