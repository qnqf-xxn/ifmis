 ...
 */
public class IndexRpDAO extends PmkpiDAO {
     ...
     * @return
     */
    public List<Map<String, Object>> getElementDatas(String guid) {
        StringBuffer sql = new StringBuffer();
        sql.append(" select t.* from V_PERF_T_INDEXCLASS ");
        sql.append(" t where t.guid='").append(guid).append("'");
        return this.queryForList(sql.toString());
    }
