...
public class CaseAuditService extends PmkpiService {
    private CaseAuditBO caseAuditBO;

    public void setCaseAuditBO(CaseAuditBO caseAuditBO) {
        this.caseAuditBO = caseAuditBO;
    }
    ...
    public Map<String, Object> getTreeData (HashMap<String, Object> params) throws AppException {
        return caseAuditBO.getTreeData(params);
    }
    ...
    public Map<String, Object> wfAudit(HashMap<String,Object> params) {
        ...
        try {
            backmap = caseAuditBO.wfAudit(params);
