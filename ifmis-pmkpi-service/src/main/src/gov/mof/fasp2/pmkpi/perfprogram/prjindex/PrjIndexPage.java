...
public class PrjIndexPage extends PmkpiPage {
     ...
     * @throws
     */
    public Map<String, Object> totalpage(HttpServletRequest request, HttpServletResponse response,
                                         Map<String, Object> config) throws Exception {
        return config;
    }
    /**
    ...
    public Map<String, Object> mergeindexadjust(HttpServletRequest request, HttpServletResponse response,
        ...
        config.put("filterbeanid", "pmkpi.filter.MergeTabFilter");
        if(reporttype == null || !"1".equals(reporttype)){//不是预算一体化，河北一体化的逻辑
    ...
    public Map<String, Object> traIndex(HttpServletRequest request, HttpServletResponse response, Map<String, Object> config) throws Exception {
        ...
        request.setAttribute("leftconfig", prjTraGoalAndIndexBO.getTreeData(procode));
        config.put("left", "lefttree");
        return config;
    }
     ...
     * @throws Exception
     */
    public Map<String, Object> sumIndex(HttpServletRequest request, HttpServletResponse response, Map<String, Object> config) throws Exception {
        return config;
    }
}
