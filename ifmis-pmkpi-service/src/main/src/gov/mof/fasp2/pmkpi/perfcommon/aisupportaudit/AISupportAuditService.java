 ...
 */
public class AISupportAuditService extends PmkpiService {
    /**
     * 注入bo.
     */
    private AISupportAuditBO aISupportAuditBO;

    /**
     * 注入bo.
     * @param aISupportAuditBO -- bo.
     * @throws
     */
    public void setAISupportAuditBO(AISupportAuditBO aISupportAuditBO) {
        this.aISupportAuditBO = aISupportAuditBO;
    }
    /**
     * 初始化加载页面.
    ...
    public Map<String, Object> loadComponent(HttpServletRequest request, HttpServletResponse response, Map config) throws Exception {
        ...
        Map<String, Object> taskdata = aISupportAuditBO.getTaskDatas();
        config.put("timeout_ms", taskdata.get("timeout_ms"));
    ...
    public Map<String, Object> getProPrompt(HashMap<String, Object> params) {
        ...
        try {
            remp = aISupportAuditBO.getProPrompt(params);
            remp.put("msg", "Y");
    ...
    public Map<String, Object> saveNewAISupportAuditDatas(HashMap<String, Object> params) {
        Map<String, Object> remp = new HashMap<String, Object>();
        try {
            remp = aISupportAuditBO.saveNewAISupportAuditDatas(params);
            remp.put("msg", "Y");
        } catch (AppException e) {
            logger.error(e.getMessage(), e);
            remp.put("msg", e.getMessage());
