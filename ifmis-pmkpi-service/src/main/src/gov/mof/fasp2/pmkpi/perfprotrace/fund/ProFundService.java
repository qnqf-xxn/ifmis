...
public class ProFundService extends PmkpiService {
    private ProFundBO proFundBO;

    public void setProFundBO(ProFundBO proFundBO) {
        this.proFundBO = proFundBO;
    }
    ...
    public Map loadComponent(HttpServletRequest request, HttpServletResponse response, Map config) throws Exception {
        ...
        String isHubei = PerfUtil.getSystemSet("IS_HUBEI");//河北资金取数
        ...
        String isGX = PerfUtil.getSystemSet("IS_GUANGXI");//是否广西模式
        ...
        config.put("is_tianjin", is_tianjin);
        config.put("isGX", isGX);
        config.put("isHubei", isHubei);
    ...
    public String getWarn(HashMap<String, Object> params) {
        return proFundBO.getWarn(params);
    }
}
