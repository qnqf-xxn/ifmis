...
public class TraceExtendService extends PmkpiService {
    private TraceExtendBO traceExtendBO;

    public void setTraceExtendBO(TraceExtendBO traceExtendBO) {
        this.traceExtendBO = traceExtendBO;
    }
    ...
    public Map<String, Object> getDatas(HashMap<String,Object> parms) throws AppException {
        return traceExtendBO.getDatas(parms);
    }
