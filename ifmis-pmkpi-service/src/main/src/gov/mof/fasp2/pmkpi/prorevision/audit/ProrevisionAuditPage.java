...
public class ProrevisionAuditPage extends PmkpiPage {
    /**
     * 调整列表
     * @param request
     * @param response
    ...
    public Map index(HttpServletRequest request, HttpServletResponse response, Map config) throws Exception {
        ...
        ProrevisionAuditBO revisionAuditBO = (ProrevisionAuditBO) ServiceFactory.getBean("pmkpi.prorevision.RevisionAuditBOTX");
        request.setAttribute("leftconfig", revisionAuditBO.getLeftTabTree(config));
