 ...
 */
public class DtPerfAdjDAO extends PmkpiDAO {
    /**
     *  部门整体调整的绩效目标。
     */
    public static final String BGT_TABLE_GOAL = "V_PERF_T_ADJUSTGOAL";
    /**
     * 部门整体调整的绩效指标.
     */
    public static final String BGT_TABLE_INDICATOR = "V_PERF_T_ADJUSTINDEX";
    /**
     * 获取模板数据
     * @return
     */
