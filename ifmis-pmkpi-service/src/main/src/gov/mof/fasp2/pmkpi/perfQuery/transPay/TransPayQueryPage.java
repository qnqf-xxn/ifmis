...
public class TransPayQueryPage extends PmkpiPage {
   ...
   public Map index(HttpServletRequest request, HttpServletResponse response, Map config) throws Exception {
	   TransPayQueryBO tlpProgramQueryBO = (TransPayQueryBO) ServiceFactory.getBean("pmkpi.perfprogram.TlpProgramQueryBOTX");
