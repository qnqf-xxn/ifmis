 ...
 */
public class AISupportAuditDetailService extends PmkpiService {
    /**
     * 注入bo.
     */
    private AISupportAuditDetailBO aISupportAuditDetailBO;

    /**
     * 注入bo.
     * @param aISupportAuditDetailBO -- bo.
     * @throws
     */
    public void setAISupportAuditDetailBO(AISupportAuditDetailBO aISupportAuditDetailBO) {
        this.aISupportAuditDetailBO = aISupportAuditDetailBO;
    }
    /**
     * 初始化加载页面.
    ...
    public Map<String, Object> getProPrompt(HashMap<String, Object> params) {
        ...
        try {
            remp = aISupportAuditDetailBO.getProPrompt(params);
            remp.put("msg", "Y");
    ...
    public Map<String, Object> saveNewAISupportAuditDatas(HashMap<String, Object> params) {
        Map<String, Object> remp = new HashMap<String, Object>();
        try {
            remp = aISupportAuditDetailBO.saveNewAISupportAuditDatas(params);
            remp.put("msg", "Y");
        } catch (AppException e) {
            logger.error(e.getMessage(), e);
            remp.put("msg", e.getMessage());
