...
public class FirstProgramQueryPage extends PmkpiPage {
   ...
   public Map index(HttpServletRequest request, HttpServletResponse response, Map config) throws Exception {
	   FirstProgramQueryBO tlpProgramQueryBO = (FirstProgramQueryBO) ServiceFactory.getBean("pmkpi.perfprogram.TlpProgramQueryBOTX");
