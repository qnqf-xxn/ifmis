...
public class FinReportAddService extends PmkpiService{

    private FinReportAddBO finReportAddBO;
    public void setFinReportAddBO(FinReportAddBO finReportAddBO) {
        this.finReportAddBO = finReportAddBO;
    }
    @Override
    ...
    public Map<String, Object> getData(HashMap<String,Object> parms) throws AppException {
        return finReportAddBO.getData(parms);
    }
    ...
    public String getProCode(HashMap<String,Object> parms) throws AppException {
        return finReportAddBO.getProCode(parms);
    }
    ...
    public Map<String, Object> getdeptData(HashMap<String,Object> parms) throws AppException {
        return finReportAddBO.getdeptData(parms);
    }
}
