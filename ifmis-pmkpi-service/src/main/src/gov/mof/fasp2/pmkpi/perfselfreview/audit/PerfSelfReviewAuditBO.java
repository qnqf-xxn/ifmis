...
public class PerfSelfReviewAuditBO extends PmkpiBO {
    public PerfSelfReviewAuditDAO perfSelfReviewAuditDAO;

    public void setPerfSelfReviewAuditDAO(PerfSelfReviewAuditDAO perfSelfReviewAuditDAO) {
        this.perfSelfReviewAuditDAO = perfSelfReviewAuditDAO;
    }
    ...
    public String getVodSql(Map sqlmap) throws AppException {
        ...
        sql.append(this.getLeftTreeWheresql(isleaf, columncode, agency, perfSelfReviewAuditDAO.PMKPI_TABLE_T_AGENCY));
        return sql.toString();
    }
    ...
    public List<Map<String, Object>> getTreeData(HashMap<String, Object> params) throws AppException {
        ...
        return perfSelfReviewAuditDAO.getLeftTree(tablecode, datarule);
    }
}
