 ...
 */
public class IndexDAO extends PmkpiDAO {
     ...
     * @return --
     */
    public List<Map<String, Object>> getAgencyDatas(String agencyguid) {
        StringBuffer sql = new StringBuffer();
        sql.append(" select distinct t.* from " + PMKPI_TABLE_T_AGENCY + " ");
        sql.append(" t start with  t.guid='").append(agencyguid).append("'");
