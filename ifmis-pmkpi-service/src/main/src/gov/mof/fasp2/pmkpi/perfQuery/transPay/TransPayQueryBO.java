...
public class TransPayQueryBO extends PmkpiBO {

    private TransPayQueryDAO transPayQueryDAO;

    public void setTransPayQueryDAO(TransPayQueryDAO transPayQueryDAO) {
        this.transPayQueryDAO = transPayQueryDAO;
    }
    ...
    public Map<String, Object> getTreeData(String menuId, String prolev) throws AppException {
        ...
        //根据权限查询单位
        List<Map<String, Object>> list = transPayQueryDAO.getTreeList(datarule);
        ...
        if ("PMKPIAGENCYALLPAY".equals(sysvalue)) {
            transPayQueryDAO.saveAll(list, transPayQueryDAO.PMKPI_TABLE_TMP_AGENCY);
        } else {
            transPayQueryDAO.saveAll(treesourcedata, transPayQueryDAO.PMKPI_TABLE_TMP_AGENCY);
        }
        //查询单位上级，合成左侧树
        List<Map<String, Object>> treelist = transPayQueryDAO.getLeftTree();
    ...
    public Map<String, Object> getData(HashMap<String, Object> params) throws AppException {
        ...
        String audit = "audit";
        if (!StringUtil.isEmpty(pagetype) && (pagetype.equals(report) || pagetype.equals(audit))) {
            s = this.getReportQuerySql(params);
            data = transPayQueryDAO.getDatas(s.toString(), wheresql, "order by update_time");
        } else {
            ...
            data = transPayQueryDAO.getDatas(tablecode, wheresql, orderby);
        }
...
//        Map<String ,String> queryParam = (Map<String, String>) queryConfig.get(0);
        ...
        if (!"1".equals(isleaf) && !"treeroot".equals(agency)) {
            ...
            transPayQueryDAO.saveAll(eledatas, transPayQueryDAO.PMKPI_TABLE_TMP_AGENCY);
        ...
        if ("1".equals(isleaf) && !"treeroot".equals(agency)) {
            ...
            sql.append(" and exists(select * from ").append(transPayQueryDAO.PMKPI_TABLE_TMP_AGENCY)
