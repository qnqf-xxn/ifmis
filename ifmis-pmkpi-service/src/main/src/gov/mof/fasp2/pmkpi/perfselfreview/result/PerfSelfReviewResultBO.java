package gov.mof.fasp2.pmkpi.perfselfreview.result;

import gov.mof.fasp2.buscore.framework.exception.AppException;
import gov.mof.fasp2.pmkpi.common.PmkpiBO;
import gov.mof.fasp2.pmkpi.perfselfreview.manage.PerfSelfReviewManageDAO;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class PerfSelfReviewResultBO extends PmkpiBO {

    public PerfSelfReviewResultDAO perfSelfReviewResultDAO;

    public void setPerfSelfReviewResultDAO(PerfSelfReviewResultDAO perfSelfReviewResultDAO) {
        this.perfSelfReviewResultDAO = perfSelfReviewResultDAO;
    }
    ...
    public String getVodSql(Map sqlmap) throws AppException {
        ...
        sql.append(this.getLeftTreeWheresql(isleaf, columncode, agency, perfSelfReviewResultDAO.PMKPI_TABLE_T_AGENCY));
        return sql.toString();
    }
    ...
    public Map<String, Object> wfAudit(HashMap<String, Object> params) throws AppException {
        ...
        String tablecode = PerfSelfReviewManageDAO.PERF_TABLE_SELFREVIEWTASK;
    ...
    public List<Map<String, Object>> getTreeData(HashMap<String, Object> params) throws AppException {
        ...
        return perfSelfReviewResultDAO.getLeftTree(tablecode, datarule);
    }
