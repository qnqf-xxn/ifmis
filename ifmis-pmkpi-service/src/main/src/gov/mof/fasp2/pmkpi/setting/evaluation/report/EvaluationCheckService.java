 ...
 */
public class EvaluationCheckService extends PmkpiService {
    /**
     * 注入bo.
     */
    private EvaluationCheckBO evaluationCheckBO;

    public void setEvaluationCheckBO(EvaluationCheckBO evaluationCheckBO) {
        this.evaluationCheckBO = evaluationCheckBO;
    }
    ...
    public Map<String, Object> saveProgramadjust(HashMap<String,Object> parms) throws AppException {
        return evaluationCheckBO.saveProgramadjust(parms);
    }
