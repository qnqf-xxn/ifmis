...
values ('D4D3D3E32DA4274CE0533315A8C0ACDD', '/pmkpi/rectification/index', 'TASKGUID', '任务名称', 7, 1, 0, 0, '0', 0, 1, null, '#name', null, 0, 150, 1, 'tree', null, null, null, null, '2016','87');

--审核状态字段
delete from p#busfw_t_uicolumn where key ='/pmkpi/rectification/index' and columncode ='WFSTATUS';
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values ('D4D3D3E32C1C274CE0533315A8C0ACDD', '/pmkpi/rectification/index', 'WFSTATUS', '审核状态', 2, 1, 0, 0, '0', 0, 1, null, '#name', null, 0, 100, 1, 'tree', null, null, null, null, '2016','87');
...
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values ('D4D3D3E32C75274CE0533315A8C0ACDD', '/pmkpi/rectification/check/proj', 'TASKGUID', '任务名称', 8, 1, 0, 0, '0', 0, 1, null, '#name', null, 0, 100, 1, 'tree', '{isjk:1}', null, null, null, '2016','87');
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values ('D4D3D3E32C79274CE0533315A8C0ACDD', '/pmkpi/rectification/check/deptproj', 'TASKGUID', '任务名称', 4, 1, 0, 0, null, 0, 1, null, '#name', null, null, 100, 1, 'tree', '{isjk:1}', null, null, null, '2016','87');
