...
values (sys_guid(), '/pmkpi/evaluation/financial/result/edit', 'V_PERF_T_FINEVALUATION', 'tree', '∆¿º€¡Ï”Ú', 'EVALUATEAREA', 0, null, 0, null, 14, null, null, 'pmkpi', 1, 0, '{"format":"#name"}', 0, 0, 0, null, null, null,'2016','87');
