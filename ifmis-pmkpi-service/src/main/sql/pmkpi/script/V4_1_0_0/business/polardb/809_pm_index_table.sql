...
begin
  ...
  --if i = 1 then
  --   execute immediate 'alter table PM_PERF_INDICATOR drop column busi_type_code';
  ---end if;
  ...
  if i = 1 then
     ...
     execute immediate 'select fn_altertablecol(''PM_PERF_INDICATOR'', ''lv1_perf_ind_code'', ''VARCHAR2'', 20)';
  end if;
  ...
  if i = 1 then
     ...
     execute immediate 'select fn_altertablecol(''PM_PERF_INDICATOR'', ''lv2_perf_ind_code'', ''VARCHAR2'', 20)';
  end if;
  ...
  if i = 1 then
     ...
     execute immediate 'select fn_altertablecol(''PM_PERF_INDICATOR'', ''lv3_perf_ind_code'', ''VARCHAR2'', 20)';
  end if;
  ...
  --select count(1) into i from user_tab_columns where table_name = 'PM_PERF_INDICATOR_TEMP' and column_name = 'BUSI_TYPE_CODE';
  --if i = 1 then
  --   execute immediate 'alter table PM_PERF_INDICATOR_TEMP drop column busi_type_code';
 -- end if;
  ...
  if i = 1 then
     ...
     execute immediate 'select fn_altertablecol(''PM_PERF_INDICATOR_TEMP'', ''lv1_perf_ind_code'', ''VARCHAR2'', 20)';
  ...
  if i = 1 then
     ...
     execute immediate 'select fn_altertablecol(''PM_PERF_INDICATOR_TEMP'', ''lv2_perf_ind_code'', ''VARCHAR2'', 20)';
  ...
  if i = 1 then
     ...
     execute immediate 'select fn_altertablecol(''PM_PERF_INDICATOR_TEMP'', ''lv3_perf_ind_code'', ''VARCHAR2'', 20)';
  end if;
