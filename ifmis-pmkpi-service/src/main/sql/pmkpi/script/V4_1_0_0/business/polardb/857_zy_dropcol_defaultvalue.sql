...
begin
  ...
  if i = 1 then
	 ...
	 execute immediate 'alter table BGT_PERF_GOAL_INFO ALTER busi_type_code set default ''2''';
  end if;
  ...
  if i = 1 then
	 ...
	 execute immediate 'alter table PM_PERF_INDICATOR ALTER busi_type_code set default ''1''';
  end if;  
  ...
  if i = 1 then
	 ...
	 execute immediate 'alter table BGT_PERF_INDICATOR ALTER busi_type_code set default ''2''';
  end if;
  ...
  if i = 1 then
    ...
    if i = 1 then
	   ...
	   execute immediate 'alter table PM_PERF_INDICATOR_ONE ALTER busi_type_code set default ''2''';
    end if;  
  end if;    
  ...
  if i = 1 then
    ...
    if i = 1 then
	   ...
	   execute immediate 'alter table BGT_PERF_GOAL_INFO_ONE ALTER busi_type_code set default ''2''';
    end if;
  end if;     
  ...
  if i = 1 then
    ...
    if i = 1 then
	   ...
	   execute immediate 'alter table BGT_PERF_INDICATOR_ONE ALTER busi_type_code set default ''2''';
    end if; 
  end if;   
