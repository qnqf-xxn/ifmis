...
values (sys_guid(), '/pmkpi/adjust/report/list', 'NAME', 'Ãû³Æ', 5, 1, 0, 0, null, null, 0, null, null, null, null, 150, 0, 's', '{}', null, '2016','87');

insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/adjust/report/list', 'AGENCY_CODE', '±àÂë', 3, 1, 0, 0, null, null, 0, null, null, null, null, 150, 0, 's', '{lefttabtype:''dept''}', null, '2016','87');

insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/adjust/report/list', 'AGENCYGUID', 'Ô¤Ëãµ¥Î»', 6, 1, 0, 0, null, null, 1, null, '#code-#name', null, null, 150, 1, 'tree', '{lefttabtype:''program''}', null, '2016','87');
