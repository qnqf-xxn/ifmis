...
values (sys_guid(), '/pmkpi/deptperformance/query/index', 'TASKTOALAMT', '金额', 5, 0, 0, 0, null, 0, 1, null, null, null, null, 100, 0, 'amt', null, null,  null, null, '2016','87');

delete from p#busfw_t_uicolumn t where key in('/pmkpi/deptperformance/audit/index') and columncode ='TASKTOALAMT';
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/deptperformance/audit/index', 'TASKTOALAMT', '金额', 5, 0, 0, 0, null, 0, 1, null, null, null, null, 100, 0, 'amt', null, null,  null, null, '2016','87');

delete from p#busfw_t_uicolumn t where key in('/pmkpi/deptperformance/report/index') and columncode ='TASKTOALAMT';
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/deptperformance/report/index', 'TASKTOALAMT', '金额', 5, 0, 0, 0, null, 0, 1, null, null, null, null, 100, 0, 'amt', null, null,  null, null, '2016','87');
