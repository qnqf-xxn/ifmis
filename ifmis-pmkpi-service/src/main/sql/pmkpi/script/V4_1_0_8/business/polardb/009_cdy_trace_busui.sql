...
values (sys_guid(), '/pmkpi/program/trace/manage/prolist', '标记重点', 0, 2, 'searchicon', 'protaskprolist.addtask', null, '标记重点', 'pmkpi', 'province', null, '{btntype:''province''}', null, null, '2016','87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/program/trace/manage/prolist', '取消标记重点', 0, 3, 'searchicon', 'protaskprolist.deltask', null, '取消标记重点', 'pmkpi', 'unprovince', null, '{btntype:''province''}', null, null, '2016','87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/program/trace/manage/prolist', '取消任务(仅标记重点模式时使用)', 0, 10, 'searchicon', 'protaskprolist.deltask', null, '取消任务(仅标记重点模式时使用)', 'pmkpi', 'delprotask', null, '{btntype:''deltask''}', null, null, '2016','87');
...
values (sys_guid(), '/pmkpi/program/trace/manage/prolist', 'PROVINCETASK', '重点项目标识', 25, 0, 0, 0, null, 0, 1, null, '#name', null, null, 100, 1, 'tree', '{lefttabtype:''alreadyaudit''}', null, null, null, '2016','87');