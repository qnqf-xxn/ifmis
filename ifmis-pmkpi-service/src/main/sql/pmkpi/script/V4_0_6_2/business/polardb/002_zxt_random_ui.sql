begin
delete from bus_t_pageconsolecomconfig where url = '/pmkpi/randomcomment/result' and componentid = 'busuidatatable';
insert into bus_t_pageconsolecomconfig (URL, COMPONENTID, CONFIG, ID, APPID, REGION)
values ('/pmkpi/randomcomment/result', 'busuidatatable', '{name:''抽评结果上传'',checkbox:true,title:''抽评结果上传'',edit:false,addrow:false,pagetype:''report'',tabcode:''V_PERF_T_RANDOMCOMMENT'',uikey:''/pmkpi/randomcomment/result/edit'',proTable:''V_PERF_T_RANDOMPROBLEM'',infotablecode:''pmkpi_t_prodetailinfo'',busguid:''108DC779F2B93101E97322F01EC532A7'',key:''/pmkpi/randomcomment/result/index''}', 'datatable', 'pmkpi', null);
