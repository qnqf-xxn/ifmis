...
Ext.lt.pmkpi.financialevaluation.proconfire = function(config, service){
    var cmp = {};
    ...
    var _menuid = config.menuid,//菜单id
        ...
        _reportproconfirm = config.reportproconfirm,
        _programhidebth = config.programhidebth,
    ...
    tabChange = function (obj) {
        ...
        common.changTooltoolbuttontStatus(0, _programhidebth + "," + _tabhidtbtn);
        cmp.setTableColum();
    ...
    cmp.clickTabpage = function(obj){
        ...
        common.changTooltoolbuttontStatus(0, _tabhidtbtn + "," + _programhidebth);
    ...
    cmp.wfAudit = function (obj){
        ...
        var params = {};
        params.datas = datas;
        params.busguid = _lefttabtype + _reportproconfirm + "_" + datas[0]["wfstatus"];
    ...
    cmp.add = function (){
        ...
        Ext.lt.ui.openModalWindow(url,scrWidth,scrHeight, "财政评价项目确定-"+_lefttreename);
    }
    ...
    cmp.checkprogram = function(){
        ...
        var url = "";
        if (_lefttabtype && "program" == _lefttabtype) { //项目支出
            url = "/pmkpi/evaluation/financial/procheck.page";
        } else if (_lefttabtype && "dept" == _lefttabtype) { //部门整体
            url = "/pmkpi/evaluation/financial/deptcheck.page";
        }
        url = Ext.lt.pmkpi.genPageUrl(url, params);
    ...
    cmp.impfile = function () {
        var data = datatable.getSelected();
        if(!data || data.length != 1){
            Ext.lt.ui.alert("请选中一条数据进行附件上传！",function(){});
            return;
        }
        var params = {};
        params.mainguid = data[0].guid;
        ...
        url = Ext.lt.pmkpi.genPageUrl(url, params);
        Ext.lt.ui.openModalWindow(url,scrWidth,scrHeight, "附件上传-"+_lefttreename);
    }
