...
Ext.lt.pmkpi.perfprogram.traceauditresults = function(config, service){
    ...
    cmp.audit = function (obj){
        ...
        params.uikey = "/pmkpi/protrace/thirdaudit/opinion";
        params.viewtype = "query";
        url = Ext.lt.pmkpi.genPageUrl(url, params);
        Ext.lt.ui.openModalWindow(url, scrWidth, scrHeight,"成果上传审核");
    }
