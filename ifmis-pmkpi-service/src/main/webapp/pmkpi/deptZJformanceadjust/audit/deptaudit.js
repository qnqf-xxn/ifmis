...
if(!Ext.lt.pmkpi.deptperf){
    Ext.lt.pmkpi.deptperf = {};
}

Ext.lt.pmkpi.deptperf.deptauditservice = function(config, service){
    ...
    var _workflow = config.workflow,
		...
		_orderby,
		_pagetype,
        _uikey = '/pmkpi/deptZJformanceadjust/report/edit',
    ...
    function query(){
        ...
        // deptcmp.querytable(datatable, params);
    }
        ...
        for(var i=0; i<cols.length; i++){
            ...
            if(col["colcode"] == "name"){
                ...
                col.onclick = function(td, el, l, c, d) {
                    var params = {};
                    var url = "/pmkpi/deptZJformance/report/edit.page";
                    params.workflow = _workflow;
                    ...
                    url = Ext.lt.pmkpi.genPageUrl(url, params);
                    Ext.lt.ui.openModalWindow(url,scrWidth-5,scrHeight-6,"部门整体绩效目标");
                };
            }
        }
    });
    ...
    cmp.wfAudit = function (obj){
        ...
        var params = {};
        params.datas = datas;
        params.tablecode = "V_PERF_T_ADJUST";
        params.workflow = _workflow;
