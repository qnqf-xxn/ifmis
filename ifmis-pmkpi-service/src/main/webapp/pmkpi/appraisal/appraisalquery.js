...
if (!Ext.lt.pmkpi.appraisalquery) {
    Ext.lt.pmkpi.appraisalquery = {};
}

Ext.lt.pmkpi.appraisalquery = function (config, service) {
    ...
    cmp.query = function () {
        ...
        params.beanid = "pmkpi.appraisal.AppraisalQueryBOTX";
