...
Ext.lt.pmkpi.performanceopen.auditservice = function(config, service) {
    ...
    Ext.lt.pmkpi.query = function(){
        ...
        params.beanid = "pmkpi.performanceopen.PerfOpenAuditBOTX";
    ...
    cmp.wfAudit = function (obj){
        ...
        for (var i = 0; i < datas.size(); i++) {
            guids.push(datas[i].guid);
        }
        params.guids = guids;
        params.workflow = _workflow;
        params.busguid = _menuid + "_" + datas[0].wfstatus;
        var url = "/pmkpi/performanceopen/auditedit.page";
        url = Ext.lt.pmkpi.genPageUrl(url, params);
        Ext.lt.ui.openModalWindow(url, scrWidth * 0.7, scrHeight * 0.7, "绩效公开"+obj["name"]);
    }
