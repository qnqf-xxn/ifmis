...
%>
<body style="height:450px;" id="ttttt">
    ...
    <div class="page-wrap">
        <div class="step-wrap">
            ...
            <div class="cont first-step-cont">
                ...
                <p>如果没有模板文件，请先在页面导出项目列表后填写导入<br>
                    <%--或下载
                    ...
                    --%>
                    <font style="color: red;height: 36px;margin-left: 108px;font-size: 13px;"><%=warningmsg %></font>
                </p>
            </div>
...
<script type="text/javascript">
    ...
    var url = "../performanceopen/importExcel.do?tokenid=" + getUrlParam('tokenid', responseWind.location.search);
    ...
    function download() {
        var aoa = [
            ['序列','状态','处室','部门','单位','项目类型','项目编码(必填)','项目名称','预算金额','项目来源','是否填报绩效','公开类型(必填)','是否公开','公开金额','公开网址','不公开原因'],
            ['','','','','','','','','','','','年初项目绩效目标','是'],
            ['','','','','','','','','','','','年中项目绩效目标','否'],
            ['','','','','','','','','','','','自评项目','']
        ];
        var sheet = XLSX.utils.aoa_to_sheet(aoa);
        openDownloadDialog(sheet2blob(sheet), '绩效公开-导入模板.xlsx');
    }
