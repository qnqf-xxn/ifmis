...
Ext.lt.pmkpi.deptZJlist = function(config, service){
    ...
    var _tablecode = "V_PERF_T_DEPTPERFDECLARE";
    ...
    Ext.lt.pmkpi.query = function(){
        ...
        params.beanid = "pmkpi.deptZJformance.DeptPerfBO";
    ...
    cmp.wfAudit = function (obj){
        ...
        // 校验页签参数
        params.checktable = "V_PERF_T_DEPTPERFDECLARE";
        params.checkkey = "/pmkpi/deptZJformance/report/edit";
