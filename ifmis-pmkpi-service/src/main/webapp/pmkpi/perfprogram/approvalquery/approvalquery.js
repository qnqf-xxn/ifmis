...
if (!Ext.lt.pmkpi.perfprogram.approvalqueryservice) {
    Ext.lt.pmkpi.perfprogram.approvalqueryservice = {};
}

Ext.lt.pmkpi.perfprogram.approvalqueryservice = function (config, service) {
    var cmp = {};
    ...
    Ext.lt.pmkpi.query = function () {
        ...
        params.beanid = "pmkpi.perfprogram.ApprovalQueryBOTX";
