...
var otherappfunc = function(){
	...
	//alert("save done!");
	var result = "";
	var url = "/pmkpi/perfprogram/saveSxGoal.do?tokenid="+getUrlParam('tokenid',responseWind.location.search)+"&authorization="+getUrlParam('authorization',responseWind.location.search)+"&year="+getUrlParam('year',responseWind.location.search);
    ...
    var editinfojson = encodeURIComponent(JSON.stringify(editinfo),"utf-8");
