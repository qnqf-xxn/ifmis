...
Ext.lt.pmkpi.perfselfreview.result = function (config, service) {
    ...
    Ext.lt.pmkpi.query = function () {
        ...
        params.beanid = "pmkpi.perfselfreview.PerfSelfReviewResultBOTX";
    ...
    cmp.wfAudit = function (obj) {
        ...
        // 校验页签参数
        params.checktable = "V_PERF_T_SELFREVIEWTASK";
        params.checkkey = _uikey;
        if (obj.code == "sendaudit" && !common.checkTabPageData(params)) {
            return false;
        }
