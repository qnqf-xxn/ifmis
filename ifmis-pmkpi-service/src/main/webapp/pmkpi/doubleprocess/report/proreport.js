...
if(!Ext.lt.pmkpi.doubleprocess.reportservice){
	Ext.lt.pmkpi.doubleprocess.reportservice = {};
}

Ext.lt.pmkpi.doubleprocess.reportservice = function(config, service){
    ...
    Ext.lt.pmkpi.query = function(){
        ...
        params.beanid = "pmkpi.doubleprocess.TlpProgramBO";
    ...
    cmp.save = function (obj){
        ...
        var params = {};
        var url = "/pmkpi/program/report/dpedit.page";
		if (data.length == 1) {
		    params.saveAgency = data[0].agencyguid; //虽然是agency也有可能是处室
            params.mainguid = data[0].pro_id; //项目的主键
