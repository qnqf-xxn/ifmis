...
if(!Ext.lt.pmkpi.evaluation.revisioncheckservice){
    Ext.lt.pmkpi.evaluation.revisioncheckservice = {};
}

Ext.lt.pmkpi.evaluation.evaluationreportcheckservice = function(config, service){
    var cmp = {};
    ...
    cmp.query = function(){
        ...
        params.beanid = "pmkpi.setting.evaluation.report.EvaluationCheckBOTX";
