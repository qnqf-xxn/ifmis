...
Ext.lt.pmkpi.case.auditservice = function(config, service){
    ...
    Ext.lt.pmkpi.query = function(){
        ...
        params.lefttabtype = _lefttabtype;
        params.leftmenuid =_leftmenuid;
        params.beanid = "pmkpi.casepage.audit.CaseAuditBOTX";
    ...
    cmp.audit = function (obj){
        ...
        params.bustype = _lefttabtype;
        if (_lefttabtype && "PM001" == _lefttabtype) { //项目支出
            params.uikey = "/pmkpi/setting/caseinfo/edit";
        } else if (_lefttabtype && "DEPT" == _lefttabtype) { //部门整体
            params.uikey = "/pmkpi/case/deptedit";
        }
