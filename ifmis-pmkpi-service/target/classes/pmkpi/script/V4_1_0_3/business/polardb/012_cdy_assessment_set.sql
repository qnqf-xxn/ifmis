...
values (sys_guid(), '/pmkpi/setting/assessment/list', 'BUSTYPE', '¿‡–Õ', 5, 1, 1, 0, null, 0, 1, null, null, null, null, 500, 0, 's', null, null, '2016', '87');

insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/setting/assessment/list', 'ORDERNUM', '≈≈–Ú', 6, 1, 0, 0, null, 0, 1, null, null, null, null, 500, 0, 's', null, null, '2016', '87');
