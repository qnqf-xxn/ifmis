...
values (sys_guid(), '/pmkpi/indexlib/deptlist', '部门指标导入', 1, 7, 'searchicon', 'indexlib.import', null, '部门指标导入', 'pmkpi', 'programimport', null, '{}', '2016', '87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/indexlib/deptlist', '部门整体指标导入', 1, 7, 'searchicon', 'indexlib.import', null, '部门整体指标导入', 'pmkpi', 'deptimport', null, '{}', '2016', '87');
