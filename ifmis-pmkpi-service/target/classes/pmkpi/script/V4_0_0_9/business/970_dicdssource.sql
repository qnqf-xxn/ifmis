...
delete from fasp_t_dicdssource t where t.code in('PMKPICATEGORY','AUDITTYPE','CATEGORY','CREDITNO','EDUCATION',
...
values ('PMKPICATEGORY', 'PMKPICATEGORY', 'PMKPICATEGORY', '绩效类型', '1', null, null, null, '2020', '87', null, null, null, '2', 'select * from v_perf_t_finevalcategory order by ordernum', null, 1, 'pmkpi');
...
--审核定义下级菜单
delete from fasp_t_dicdssource where code = 'SUPERGUID';
insert into fasp_t_dicdssource (GUID, CODE, ELEMENTCODE, NAME, STATUS, CREATETIME, STARTTIME, ENDTIME, YEAR, PROVINCE, CRC, TYPEGUID, SHOWSTRUCT, SOURCETYPE, DATASOURCE, DBVERSION, VERSION, APPID)
values ('SUPERGUID', 'SUPERGUID', 'SUPERID', '父类菜单ID', '1', '20210405174801359', '20210405', null, '2016', '87', '5', '202100', '1', '2', 'select t.guid,t.code,t.name,t.status from fasp_t_pubmenu t where t.appid=''pmkpi'' order by code', null, 1, 'pmkpi');
