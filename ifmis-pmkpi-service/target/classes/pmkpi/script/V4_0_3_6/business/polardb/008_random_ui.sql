...
begin
--范围标识-UI表注册
delete from busfw_t_uitable t where t.key = '/pmkpi/randomcomment/scope/index';
...
--范围标识(项目支出)-列注册
delete from busfw_t_uicolumn t where t.key in('/pmkpi/randomcomment/scope/index');
...
--范围标识-按钮注册
delete from busfw_t_uifunction t where t.key = '/pmkpi/randomcomment/scope/index';
...
--范围标识-查询区注册
delete from busfw_t_uiqueryform t where t.key = '/pmkpi/randomcomment/scope/index';
...
--范围标识-页签注册
delete from busfw_t_uitabpage where key = '/pmkpi/randomcomment/scope';
...
values (sys_guid(), 'pmkpi', '/pmkpi/randomcomment/scope', '待标识', '1', 1, 1, 'choosed', 'randomcommentscope.clickTabpage', null, '待标识', 'toident', null, '{}', null, '0', null, null, null, null, null, null, null,'2016','87');

insert into busfw_t_uitabpage (GUID, APPID, KEY, NAME, CODE, ISVISIABLE, ORDERNUM, CLASSNAME, CLICK, DISABLED, TITLE, FILTER, HIDEBTNS, CONFIG, WFSTATUS, WAITFLAG, COMPONENTID, COMPONENTCONFIG, COMPONENTKEY, COMPONENTDRAW, COMPONENTSERVICEID, COMPONENTCALLBACKFN, DEFAULTFILTER, YEAR, PROVINCE)
values (sys_guid(), 'pmkpi', '/pmkpi/randomcomment/scope', '已标识', '2', 1, 2, 'nomal', 'randomcommentscope.clickTabpage', null, '已标识', 'isident', null, '{}', null, '0', null, null, null, null, null, null, null,'2016','87');
...
--范围标识(部门整体)-列注册
delete from busfw_t_uicolumn t where t.key in('/pmkpi/randomcomment/scope/dept');
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL,PROVINCE, YEAR)
...
--抽评对象确定-UI表注册
delete from busfw_t_uitable t where t.key = '/pmkpi/randomcomment/object/index';
insert into busfw_t_uitable (GUID, KEY, TABLECODE, PAGENUM, TOTALTAG, LOCKNUM, ORDERBY, DEFQUERY, APPID, CONFIG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/object/index', 'V_PERF_T_RANDOMCOMMENT_PROJ', 100, 1, 0, null, null, 'pmkpi', null,'2016','87');

--抽评对象确定(项目支出)-列注册
delete from busfw_t_uicolumn t where t.key in('/pmkpi/randomcomment/object/index');
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL,PROVINCE, YEAR)
...
--抽评对象确定-按钮注册
delete from busfw_t_uifunction t where t.key = '/pmkpi/randomcomment/object/index';
insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, YEAR, PROVINCE)
...
--抽评对象确定-查询区注册
delete from busfw_t_uiqueryform t where t.key = '/pmkpi/randomcomment/object/index';
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
...
--抽评对象确定-页签注册
delete from busfw_t_uitabpage where key = '/pmkpi/randomcomment/object';
insert into busfw_t_uitabpage (GUID, APPID, KEY, NAME, CODE, ISVISIABLE, ORDERNUM, CLASSNAME, CLICK, DISABLED, TITLE, FILTER, HIDEBTNS, CONFIG, WFSTATUS, WAITFLAG, COMPONENTID, COMPONENTCONFIG, COMPONENTKEY, COMPONENTDRAW, COMPONENTSERVICEID, COMPONENTCALLBACKFN, DEFAULTFILTER, YEAR, PROVINCE)
...
--随机抽取管理-UI表注册
delete from busfw_t_uitable t where t.key = '/pmkpi/randomcomment/random/index';
insert into busfw_t_uitable (GUID, KEY, TABLECODE, PAGENUM, TOTALTAG, LOCKNUM, ORDERBY, DEFQUERY, APPID, CONFIG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/random/index', 'V_PERF_T_RANDOMCOMMENT_PROJ', 100, 1, 0, null, null, 'pmkpi', null,'2016','87');

--随机抽取管理(项目支出)-列注册
delete from busfw_t_uicolumn t where t.key in('/pmkpi/randomcomment/random/index');
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL,PROVINCE, YEAR)
...
--随机抽取管理-按钮注册
delete from busfw_t_uifunction t where t.key = '/pmkpi/randomcomment/random/index';
insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, YEAR, PROVINCE)
...
--随机抽取管理-查询区注册
delete from busfw_t_uiqueryform t where t.key = '/pmkpi/randomcomment/random/index';
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
...
--随机抽取管理-页签注册
delete from busfw_t_uitabpage where key = '/pmkpi/randomcomment/randoms';
insert into busfw_t_uitabpage (GUID, APPID, KEY, NAME, CODE, ISVISIABLE, ORDERNUM, CLASSNAME, CLICK, DISABLED, TITLE, FILTER, HIDEBTNS, CONFIG, WFSTATUS, WAITFLAG, COMPONENTID, COMPONENTCONFIG, COMPONENTKEY, COMPONENTDRAW, COMPONENTSERVICEID, COMPONENTCALLBACKFN, DEFAULTFILTER, YEAR, PROVINCE)
...
--绩效抽评委托-UI表注册
delete from busfw_t_uitable t where t.key = '/pmkpi/randomcomment/entrust/index';
insert into busfw_t_uitable (GUID, KEY, TABLECODE, PAGENUM, TOTALTAG, LOCKNUM, ORDERBY, DEFQUERY, APPID, CONFIG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'V_PERF_T_RANDOMCOMMENT_PROJ', 100, 1, 0, null, null, 'pmkpi', null,'2016','87');

--绩效抽评委托(项目支出)-列注册
delete from busfw_t_uicolumn t where t.key in('/pmkpi/randomcomment/entrust/index');
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL,PROVINCE, YEAR)
...
--绩效抽评委托-按钮注册
delete from busfw_t_uifunction t where t.key = '/pmkpi/randomcomment/entrust/index';
insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, YEAR, PROVINCE)
...
--绩效抽评委托-查询区注册
delete from busfw_t_uiqueryform t where t.key = '/pmkpi/randomcomment/entrust/index';
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'PROJNAME', '项目名称', 1, 1, 's', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'WFSTATUS', '审核状态', 2, 0, 'tree', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'FININTORGGUID', '业务处室', 3, 1, 'tree', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'PROJTYPE', '项目类别', 4, 0, 'tree', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'AMTMAX', '全年预算数≥（万元）', 5, 1, 's', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/entrust/index', 'AMTMIN', '全年预算数≤（万元）', 6, 1, 's', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
...
--抽评结果上传-查询区注册
delete from busfw_t_uiqueryform t where t.key = '/pmkpi/randomcomment/result/index';
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/result/index', 'PROJNAME', '项目名称', 1, 1, 's', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/result/index', 'WFSTATUS', '审核状态', 2, 0, 'tree', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/result/index', 'FININTORGGUID', '业务处室', 3, 1, 'tree', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/result/index', 'PROJTYPE', '项目类别', 4, 0, 'tree', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/result/index', 'AMTMAX', '全年预算数≥（万元）', 5, 1, 's', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
insert into busfw_t_uiqueryform (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, TYPE, DEFAULTVALUE, LINKCHILD, LINKPARENT, APPID, TABLECODE, CONFIG, BOTTOMCONTRL, REQUIREMENT, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/randomcomment/result/index', 'AMTMIN', '全年预算数≤（万元）', 6, 1, 's', null, null, null, 'pmkpi', 'V_PERF_T_RANDOMCOMMENT_PROJ', '{}', null, null,'2016','87');
