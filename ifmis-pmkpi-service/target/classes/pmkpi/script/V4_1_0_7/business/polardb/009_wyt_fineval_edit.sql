...
values (sys_guid(), '/pmkpi/evaluation/finconfirm/edit', 'V_PERF_T_FINEVALUATION', 'tree', '类别', 'FUND_TYPE', 0, null, 1, null, 19, null, null, 'pmkpi', 1, 0, '{"format":"#code-#name"}', 0, 0, 0, null, null, null, '2016','87');
insert into busfw_t_uieditform (GUID, KEY, TABLECODE, TYPE, NAME, COLUMNCODE, ISVISIABLE, SHOWLEVEL, REQUIREMENT, DEFAULTVALUE, ORDERNUM, COLSPANNUM, TEXTAREAROWS, APPID, ISEDIT, LEVELCONTROL, CONFIG, FROMSOURCE, BOTTOMCONTRL, SETVALUE, HEAD, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/evaluation/finconfirm/edit', 'V_PERF_T_FINEVALUATION', 'textarea', '项目概况', 'PRO_DESC', 0, null, 1, null, 20, 2, '3', 'pmkpi', 1, 0, '{}', 0, 0, 0, null, null, null, '2016','87');
...
insert into busfw_t_uieditform (GUID, KEY, TABLECODE, TYPE, NAME, COLUMNCODE, ISVISIABLE, SHOWLEVEL, REQUIREMENT, DEFAULTVALUE, ORDERNUM, COLSPANNUM, TEXTAREAROWS, APPID, ISEDIT, LEVELCONTROL, CONFIG, FROMSOURCE, BOTTOMCONTRL, SETVALUE, HEAD, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/evaluation/financial/result/edit', 'V_PERF_T_FINEVALUATION', 'i', '分数', 'SCORE', 1, null, 1, null, 6, null, null, 'pmkpi', 1, null, '{}', null, null, null, null, null, null, '2016','87');

insert into busfw_t_uieditform (GUID, KEY, TABLECODE, TYPE, NAME, COLUMNCODE, ISVISIABLE, SHOWLEVEL, REQUIREMENT, DEFAULTVALUE, ORDERNUM, COLSPANNUM, TEXTAREAROWS, APPID, ISEDIT, LEVELCONTROL, CONFIG, FROMSOURCE, BOTTOMCONTRL, SETVALUE, HEAD, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/evaluation/financial/result/edit', 'V_PERF_T_FINEVALUATION', 'textarea', '存在的问题', 'EXISTQUESTION', 1, null, 1, null, 10, 3, '3', 'pmkpi', 1, null, '{}', null, null, null, null, null, null, '2016','87');

insert into busfw_t_uieditform (GUID, KEY, TABLECODE, TYPE, NAME, COLUMNCODE, ISVISIABLE, SHOWLEVEL, REQUIREMENT, DEFAULTVALUE, ORDERNUM, COLSPANNUM, TEXTAREAROWS, APPID, ISEDIT, LEVELCONTROL, CONFIG, FROMSOURCE, BOTTOMCONTRL, SETVALUE, HEAD, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/evaluation/financial/result/edit', 'V_PERF_T_FINEVALUATION', 'textarea', '应用建议', 'FEEDBACK', 1, null, 1, null, 11, 3, '3', 'pmkpi', 1, null, '{}', null, null, null, null, null, null, '2016','87');
...
values (sys_guid(), '/pmkpi/evaluation/financial/program', 'FUND_TYPE', '类别', 22, 1, 0, null, null, null, 1, null, '#name', null, null, null, 1, 'tree', '{ispro:1}', null,  null, null, '2016','87');

insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/evaluation/financial/program', 'PRO_TOTAL_AMT', '项目总金额', 23, 1, 0, null, null, null, 1, null, null, null, null, null, 0, 's', '{ispro:1}', null,  null, null, '2016','87');
