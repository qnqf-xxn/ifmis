...
values (sys_guid(), '/pmkpi/deptperformance/report/edit', '复制上年目标', 0, 0, 'Keepicon', 'tabfreamedit.copylastyeargoal', null, '复制上年目标', 'pmkpi', 'copylastyeargoal', null, '{}', null, null, '2016','87');
...
insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/deptperformance/report/perfindex', '复制上年指标', 0, 9, 'keepicon', 'deptindex.copylastyearindex', null, '复制上年指标', 'pmkpi', 'copylastyearindex', null, null, null, null ,'2016','87');
