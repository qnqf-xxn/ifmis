...
values (sys_guid(), '/pmkpi/evaluation/dept/resultaudit', '成果审核', 0, 8, 'searchicon', 'deptevaluationresult.evalaudit', null, '成果审核', 'pmkpi', 'evalaudit', null, '{}', null, null);
...
values (sys_guid(), 'pmkpi', '/pmkpi/evaluation/dept/result/edit', '评价成果(处室)', 'finresultfile', 0, 6, 'nomal', 'tabfreamedit.clickTabpage', null, '评价成果(处室)', null, '保存', '{filebustype:''findeptevaproresult'',url:''/pmkpi/upload/file/index.page''}', null, '0', 'manceiframe', null, null, null, null, null, null, null, null);
