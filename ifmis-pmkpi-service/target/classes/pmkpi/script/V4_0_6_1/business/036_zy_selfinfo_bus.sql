...
values (sys_guid(), '/pmkpi/perfself/apply/editdept/selfinfo', 'V_PERF_T_EVALUATEINFO', 's', '自评得分', 'SELFSCORE', 1, null, 0, null, 7, null, null, 'pmkpi', 1, null, '{}', null, null, null, null, null, null);

delete from p#busfw_t_uieditform where key = '/pmkpi/perfself/apply/edit/selfinfo' and columncode = 'SELFSCORE';
insert into busfw_t_uieditform (GUID, KEY, TABLECODE, TYPE, NAME, COLUMNCODE, ISVISIABLE, SHOWLEVEL, REQUIREMENT, DEFAULTVALUE, ORDERNUM, COLSPANNUM, TEXTAREAROWS, APPID, ISEDIT, LEVELCONTROL, CONFIG, FROMSOURCE, BOTTOMCONTRL, SETVALUE, HEAD, ISEDITCTRL, EDITCTRLMSG)
values (sys_guid(), '/pmkpi/perfself/apply/edit/selfinfo', 'V_PERF_T_EVALUATEINFO', 's', '自评得分', 'SELFSCORE', 1, null, 0, null, 11, null, null, 'pmkpi', 1, null, '{}', null, null, null, null, null, null);
