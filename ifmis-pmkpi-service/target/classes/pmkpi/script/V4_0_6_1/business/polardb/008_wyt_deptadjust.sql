...
values (sys_guid(), 'pmkpi', '/pmkpi/adjust/report/deptedit', '广西-部门职能活动', 'deptfun', 0, 11, 'nomal', 'tabfreamedit.clickTabpage', null, '部门职能活动', null, null, '{busguid:''12F7B8C868E54306A2FDE7CCC32726FC'',action:''deptfunc.save'',url:''/pmkpi/deptperformance/report/funcd.page?isadjust=1''}', null, '0', 'funciframe', null, null, null, null, null, null, null, null,'2016','87');
