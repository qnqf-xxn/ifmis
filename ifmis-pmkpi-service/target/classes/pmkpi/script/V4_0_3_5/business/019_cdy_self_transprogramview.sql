begin
execute immediate '
create or replace view v_perf_selfbdgpay_transprogram as
select t.bgtsource as name, --资金来源
       (case when t.bgtsource = ''预算内'' then 1
        when t.bgtsource = ''其他资金'' then 2
          when t.bgtsource = ''专户资金'' then 3
        else 9
 ...
 group by t.bgtsource, t.pro_code, t.year, t.province, t.agencyguid'
;
