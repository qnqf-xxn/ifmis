 ...
 --BAS_PERF_INDICATORÐÂÔö×Ö¶Î
  	SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('FINDEX');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add FINDEX varchar2(300)';
  END IF;  	 		
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('SINDEX');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add SINDEX varchar2(300)';
  ...
  SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('TARGETVALUE');
...
SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('BIZ_KEY');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add BIZ_KEY varchar2(38)';
  ...
  SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('CODE');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add CODE varchar2(300)';
  ...
  SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('NAME');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add NAME varchar2(1000)';
  ...
  SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('PERF_IND_CODE');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add PERF_IND_CODE varchar2(300)';
  END IF;
    ...
    SELECT COUNT(1) INTO num from cols where table_name = upper('BAS_PERF_INDICATOR') and column_name = upper('PERF_IND_NAME');
 ...
 execute immediate 'alter table BAS_PERF_INDICATOR add PERF_IND_NAME varchar2(1000)';
  END IF;  
    ...
    --PM_PERF_INDICATOR
          SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('NAME');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add NAME varchar2(10000)';
  END IF; 
           ...
           SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('CODE');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add CODE varchar2(300)';
  END IF; 
       ...
       SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('KPI_LV1');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add KPI_LV1 varchar2(300)';
  END IF;  
   ...
   SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('KPI_LV2');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add KPI_LV2 varchar2(300)';
  END IF; 
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('KPI_LV3');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add KPI_LV3 varchar2(300)';
  END IF;  	
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('FINDEX');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add FINDEX varchar2(300)';
  END IF;  	 		
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('SINDEX');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add SINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('TINDEX');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add TINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('KPI_VAL');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add KPI_VAL varchar2(1000)';
  END IF; 
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('INDEXVAL');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR add INDEXVAL varchar2(1000)';
  ...
  SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('TARGETVALUE');
...
SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('AGENCY_CODE');
 ...
 SELECT COUNT(1)  INTO num from cols  where table_name = upper('PM_PERF_INDICATOR') and column_name = upper('BUSI_TYPE_CODE');
 ...
 SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR')  and column_name = upper('BUSI_TYPE');
 ...
 END IF;   
	...
	--	PM_PERF_INDICATOR_TEMP
	 SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('CODE');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add CODE varchar2(300)';
  END IF;  
   SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('NAME');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add NAME varchar2(1000)';
  END IF; 
 SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('KPI_LV1');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add KPI_LV1 varchar2(300)';
  END IF;  
   ...
   SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('KPI_LV2');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add KPI_LV2 varchar2(300)';
  END IF; 
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('KPI_LV3');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add KPI_LV3 varchar2(300)';
  END IF;  	
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('FINDEX');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add FINDEX varchar2(300)';
  END IF;  	 		
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('SINDEX');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add SINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('TINDEX');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add TINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('KPI_VAL');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add KPI_VAL varchar2(1000)';
  END IF; 
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('INDEXVAL');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add INDEXVAL varchar2(1000)';
  END IF;  	
    ...
    SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('TARGETVALUE');
...
SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('AGENCY_CODE');
 ...
 execute immediate 'alter table PM_PERF_INDICATOR_TEMP add AGENCY_CODE varchar2(21)';
  END IF; 
   ...
   SELECT COUNT(1)  INTO num from cols  where table_name = upper('PM_PERF_INDICATOR_TEMP') and column_name = upper('BUSI_TYPE_CODE');
 ...
 SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_INDICATOR_TEMP')  and column_name = upper('BUSI_TYPE');
 ...
 END IF;   
  ...
  -- PM_PERF_GOAL_INFO
  SELECT COUNT(1)  INTO num from cols  where table_name = upper('PM_PERF_GOAL_INFO') and column_name = upper('AGENCY_CODE');
...
SELECT COUNT(1)  INTO num from cols  where table_name = upper('PM_PERF_GOAL_INFO') and column_name = upper('BUSI_TYPE_CODE');
 ...
 SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_GOAL_INFO')  and column_name = upper('BUSI_TYPE');
 ...
 END IF;   
  ...
  --PM_PERF_GOAL_TEMP
    SELECT COUNT(1)  INTO num from cols  where table_name = upper('PM_PERF_GOAL_TEMP') and column_name = upper('AGENCY_CODE');
    ...
    END IF;  
       SELECT COUNT(1)  INTO num from cols  where table_name = upper('PM_PERF_GOAL_TEMP') and column_name = upper('BUSI_TYPE_CODE');
 ...
 SELECT COUNT(1) INTO num from cols where table_name = upper('PM_PERF_GOAL_TEMP')  and column_name = upper('BUSI_TYPE');
 ...
 END IF;   
    ...
    --BGT_PERF_GOAL_INFO
        SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_GOAL_INFO') and column_name = upper('ADJ_BATCH_NO');
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_GOAL_INFO') and column_name = upper('BUSI_TYPE_CODE');
   ...
   -- BGT_PERF_INDICATOR
    SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('KPI_LV1');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add KPI_LV1 varchar2(300)';
  END IF;  
   ...
   SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('KPI_LV2');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add KPI_LV2 varchar2(300)';
  END IF; 
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('KPI_LV3');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add KPI_LV3 varchar2(300)';
  END IF;  	
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('FINDEX');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add FINDEX varchar2(300)';
  END IF;  	 		
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('SINDEX');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add SINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('TINDEX');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add TINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('KPI_VAL');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add KPI_VAL varchar2(1000)';
  END IF;
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('INDEXVAL');
 ...
 END IF;
  ...
  SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('TARGETVALUE');
 ...
 execute immediate 'alter table BGT_PERF_INDICATOR add TARGETVALUE varchar2(1000)';
  END IF;  
   ...
   SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR') and column_name = upper('ADJ_BATCH_NO');
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('BGT_PERF_INDICATOR')  and column_name = upper('BUSI_TYPE_CODE');
 ...
 --PERF_T_ADJUSTGOAL
 	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTGOAL')  and column_name = upper('BUSI_TYPE_CODE');
     ...
     SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTGOAL') and column_name = upper('AGENCY_CODE');
 ...
 execute immediate 'alter table PERF_T_ADJUSTGOAL add AGENCY_CODE varchar2(21)';
  END IF; 
     ...
     --PERF_T_ADJUSTINDEX
      SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('CODE');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add CODE varchar2(300)';
  END IF;  
   SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('NAME');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add NAME varchar2(1000)';
  END IF; 
 SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('KPI_LV1');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add KPI_LV1 varchar2(300)';
  END IF;  
   ...
   SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('KPI_LV2');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add KPI_LV2 varchar2(300)';
  END IF; 
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('KPI_LV3');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add KPI_LV3 varchar2(300)';
  END IF;  	
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('FINDEX');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add FINDEX varchar2(300)';
  END IF;  	 		
  	...
  	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('SINDEX');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add SINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('TINDEX');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add TINDEX varchar2(300)';
  END IF;  
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('KPI_VAL');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add KPI_VAL varchar2(1000)';
  END IF; 
	...
	SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('INDEXVAL');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add INDEXVAL varchar2(1000)';
  END IF;  	
    ...
    SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('TARGETVALUE');
...
SELECT COUNT(1) INTO num from cols where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('AGENCY_CODE');
 ...
 execute immediate 'alter table PERF_T_ADJUSTINDEX add AGENCY_CODE varchar2(21)';
  END IF; 
   ...
   SELECT COUNT(1)  INTO num from cols  where table_name = upper('PERF_T_ADJUSTINDEX') and column_name = upper('BUSI_TYPE_CODE');
