...
values (sys_guid(), '/pmkpi/evaluation/financial/proconfirm', '查看项目库信息', 0, 18, 'searchicon', 'finproconfirm.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');

delete from p#Busfw_t_uifunction t where t.key='/pmkpi/evaluation/financial/deptassessment/list' and code ='showProjView';

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, PROVINCE, YEAR)
values (sys_guid(), '/pmkpi/evaluation/financial/deptassessment/list', '查看项目库信息', 0, 18, 'searchicon', 'findeptassessment.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');

delete from p#Busfw_t_uifunction t where t.key='/pmkpi/evaluation/financial/audit' and code ='showProjView';

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, PROVINCE, YEAR)
values (sys_guid(), '/pmkpi/evaluation/financial/audit', '查看项目库信息', 0, 18, 'searchicon', 'finevalaudit.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');

delete from p#Busfw_t_uifunction t where t.key='/pmkpi/evaluation/financial/resultupload' and code ='showProjView';

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, PROVINCE, YEAR)
values (sys_guid(), '/pmkpi/evaluation/financial/resultupload', '查看项目库信息', 0, 18, 'searchicon', 'finevaluationresult.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');

delete from p#Busfw_t_uifunction t where t.key='/pmkpi/evaluation/financial/resultaudit' and code ='showProjView';

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, PROVINCE, YEAR)
values (sys_guid(), '/pmkpi/evaluation/financial/resultaudit', '查看项目库信息', 0, 18, 'searchicon', 'finevaluationresult.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');

delete from p#Busfw_t_uifunction t where t.key='/pmkpi/evaluation/financial/feedback' and code ='showProjView';

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, PROVINCE, YEAR)
values (sys_guid(), '/pmkpi/evaluation/financial/feedback', '查看项目库信息', 0, 18, 'searchicon', 'finevaluationresult.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');

delete from p#Busfw_t_uifunction t where t.key='/pmkpi/evaluation/financial/query' and code ='showProjView';

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, PROVINCE, YEAR)
values (sys_guid(), '/pmkpi/evaluation/financial/query', '查看项目库信息', 0, 18, 'searchicon', 'finevalquery.showProjView', null, '查看项目库信息', 'pmkpi', 'showProjView', null, null, '87', '2016');
