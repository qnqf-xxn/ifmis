...
values (sys_guid(), '/pmkpi/perfselftaskmanage/index', '标记重点', 0, 4, null, 'perfselfmanage.provincetask', null, '标记重点', 'pmkpi', 'province', null, null, null, null, '2016','87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/perfselftaskmanage/index', '取消标记重点', 0, 5, 'searchicon', 'perfselfmanage.provincetask', null, '取消标记重点', 'pmkpi', 'unprovince', null, null, null, null, '2016','87');
...
values (sys_guid(), '/pmkpi/perfself/taskmanage', 'PROVINCETASK', '重点项目标识', 25, 0, 0, 0, null, 0, 1, null, '#name', null, null, 100, 1, 'tree', '{lefttabtype:''program''}', null, null, null, '2016','87');
...
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR, PROVINCE)
values (sys_guid(), '/pmkpi/perfself/query', 'PROVINCETASK', '重点项目标识', 25, 0, 0, 0, null, 0, 1, null, '#name', null, null, 100, 1, 'tree', '{lefttabtype:''program''}', null, null, null, '2016','87');
