...
values (sys_guid(), '/pmkpi/set/uifunctioncols/edit', '查看导出模版配置', 1, 2, 'Keepicon', 'pmkpiuiset.queryexpdoc', null, '查看导出模版配置', 'pmkpi', 'queryexpdoc', null, null, null, null, '2016','87');
