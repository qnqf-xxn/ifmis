...
select t.guid,
  ...
  left join v_perf_t_frame a on t.findex = a.guid and a.frametype=''PM001''
  left join v_perf_t_frame b on t.sindex = b.guid and b.frametype=''PM001''
  left join v_perf_enum    e on t.computesign = e.code and e.elementcode=''PMKPIZBXS''
where
  t.is_deleted =2 and t.is_backup = 2 and t.province = global_multyear_cz.v_pmdivid';
