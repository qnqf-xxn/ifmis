...
begin
  ...
  if i = 1 then
     ...
     execute immediate 'alter table BGT_PERF_INDICATOR modify lv1_perf_ind_code VARCHAR2(20)';
  end if;
  ...
  if i = 1 then
     ...
     execute immediate 'alter table BGT_PERF_INDICATOR modify lv2_perf_ind_code VARCHAR2(20)';
  end if;
  ...
  if i = 1 then
     ...
     execute immediate 'alter table BGT_PERF_INDICATOR modify lv3_perf_ind_code VARCHAR2(20)';
  end if;
