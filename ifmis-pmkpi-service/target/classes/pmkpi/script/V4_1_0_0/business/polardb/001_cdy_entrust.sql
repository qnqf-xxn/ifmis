...
values (sys_guid(), '/pmkpi/review/entrust/expert', 'ISGROUP', '是否组长', 1, 1, 1, 0, null, 0, 2, null, null, null, null, null, 0, 's', null, null, null, null, '2016','87');

delete from p#busfw_t_uicolumn t where t.key in('/pmkpi/review/entrust/selexpert') and t.columncode in('ISGROUP');
insert into busfw_t_uicolumn (GUID, KEY, COLUMNCODE, NAME, ORDERNUM, ISVISIABLE, ISEDIT, TOTALTAG, SHOWLEVEL, REQUIREMENT, COLTYPE, HEAD, FORMAT, DEFAULTVALUE, LEVELCONTROL, COLWIDTH, ISSOURCE, TYPE, CONFIG, BOTTOMCONTRL, ISEDITCTRL, EDITCTRLMSG, YEAR,PROVINCE)
values (sys_guid(), '/pmkpi/review/entrust/selexpert', 'ISGROUP', '是否组长', 1, 1, 0, 0, null, 0, 1, null, '#code-#name', null, null, null, 1, 'tree', null, null, null, null, '2016','87');
...
values (sys_guid(), '/pmkpi/review/entrust/expert', '保存', 0, 1, 'searchicon', 'pmkpientrustexpert.save', null, '保存', 'pmkpi', 'save', null, '{}', null, null, '2016','87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR,PROVINCE)
values (sys_guid(), '/pmkpi/review/entrust/expert', '删除', 1, 2, 'searchicon', 'pmkpientrustexpert.del', null, '删除', 'pmkpi', 'del', null, '{}', null, null, '2016','87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR,PROVINCE)
values (sys_guid(), '/pmkpi/review/entrust/expert', '审核', 0, 3, 'searchicon', 'pmkpientrustexpert.saveaudit', null, '审核', 'pmkpi', 'audit', null, '{}', null, null, '2016','87');

insert into busfw_t_uifunction (GUID, KEY, NAME, ISVISIABLE, ORDERNUM, CLASSNAME, ACTION, DISABLED, TITLE, APPID, CODE, PARAM, CONFIG, ISEDITCTRL, EDITCTRLMSG, YEAR,PROVINCE)
values (sys_guid(), '/pmkpi/review/entrust/expert', '保存并审核', 1, 4, 'searchicon', 'pmkpientrustexpert.saveaudit', null, '保存并审核', 'pmkpi', 'saveaudit', null, '{}', null, null, '2016','87');
